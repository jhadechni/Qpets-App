...
class PetLocalDatabase {
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute(
        'CREATE TABLE pets (_id TEXT PRIMARY KEY, name TEXT, image TEXT, dob TEXT,breed TEXT, type TEXT, gender TEXT, weight TEXT, ownerId TEXT, vaccineCheck TEXT, chipCheck TEXT, spayedAndNeutered TEXT)');
  }
